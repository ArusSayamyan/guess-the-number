<template>
  <div class="gameWrapper">
    ...
    <form class="gameWrapper__setNumber" @submit.prevent="submitForm">
      <input type="number" class="gameWrapper__enterNumber" required placeholder="Enter your guess" maxlength="4" minlength="4" pattern="^(?!.*(.).*\1)[1-9]{1,4}$" v-model="enteredNumber">
